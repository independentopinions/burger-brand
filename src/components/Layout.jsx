                ...
                >
                    ...
                    <div className={`absolute bottom-8 left-8 right-8 flex justify-between items-end border-t-2 border-brand-bg/20 pt-6 ${isMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} transition-all duration-500 delay-[600ms]`}>
                        <div className="flex flex-col gap-1">
                            <h2 className="text-2xl font-black italic text-brand-accent tracking-tighter opacity-80">B&B</h2>
                        </div>
                        <a href="https://t.me/burgerbrand" target="_blank" rel="noreferrer" className="text-sm font-bold tracking-widest uppercase text-brand-bg hover:text-[#0088cc] transition-colors">
                            Telegram
                        </a>
                    </div>
                </div>
                    ...
                    <footer ref={footerRef} className="bg-[#1b1407] text-[#fdfbf7] p-4 md:p-6 mt-auto z-20 relative opacity-0">
                        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-6">
                            ...
                            <div className="text-center md:text-left flex flex-col gap-1">
                                <h2 className="text-2xl md:text-3xl font-black italic text-brand-accent tracking-tighter">BurgerBrand</h2>
                                <p className="text-xs opacity-60">© 2026 BurgerBrand. All rights reserved.</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center gap-2 md:absolute md:left-1/2 md:-translate-x-1/2">
                                <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm font-bold tracking-widest uppercase">
                                    ...
                                    <a href="https://t.me/burgerbrand" target="_blank" rel="noreferrer" className="opacity-80 hover:opacity-100 hover:text-[#0088cc] transition-colors">Telegram</a>
                                </div>
                                <a href="mailto:hello@burgerbrand.com" target="_blank" rel="noreferrer" className="text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-60 hover:opacity-100 hover:text-brand-accent transition-colors mt-1">
                                    связь: hello@burgerbrand.com
                                </a>
                            </div>
