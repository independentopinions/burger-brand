...
export default function Menu() {
    useEffect(() => {
        document.title = "Меню | Spot&Choo's";
    }, []);
                ...
                <div className="px-4 lg:px-8 mt-12 pt-12 border-t-2 border-brand-text/10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-8">
                            ...
                            <div className="text-center md:text-left">
                                <h3 className="font-black text-lg md:text-xl uppercase tracking-tighter mb-2 text-brand-text">
                                    ДВОЙНЫЕ БАЛЛЫ В ПРИЛОЖЕНИИ SPOT&CHOO'S
                                </h3>
                                <p className="text-xs md:text-sm font-medium mb-2">Используй бонусную карту при каждом заказе в Spot&Choo's и получай баллы.</p>
                        ...
                        <div className="border-[2px] border-dashed border-brand-accent p-4 md:p-6 flex flex-col md:flex-row gap-6 items-center bg-brand-accent/5">
                            ...
                            <div className="w-24 h-24 shrink-0 bg-white p-2 border-2 border-brand-text">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://m.loyaltyplant.com/3177" alt="QR Code" className="w-full h-full mix-blend-multiply" />
                            </div>
                            <div className="text-center md:text-left">
                                <h3 className="text-brand-accent font-black uppercase text-lg mb-2 tracking-tighter">СЧАСТЛИВЫЕ ЧАСЫ</h3>
                                <p className="font-bold text-sm leading-tight">с 12:00 до 16:00, в<br />рабочие дни:<br />получай 20% от заказа<br />баллами</p>
                            </div>
                        </div>
                    ...
                    <div className="mt-16 flex flex-col md:flex-row justify-between items-end border-t-2 border-brand-text/10 pt-8 gap-8">
                        <div className="grid grid-cols-2 gap-x-8 gap-y-1 text-xs md:text-sm font-bold">
                            <div>@SPOTANDCHOOS</div>
                            <div>SPOTANDCHOOS.COM</div>

                            <div className="mt-4 font-medium">Ильича, 10</div>
                            <div className="mt-4 font-medium">+7 983 312 14 20</div>

                            <div className="font-medium">Коммунистическая, 45</div>
                            <div className="font-medium">+7 983 302 04 20</div>

                            <div className="font-medium">Ленина, 3</div>
                            <div className="font-medium">+7 913 203 04 20</div>

                            <div className="font-medium">Блюхера, 32/1</div>
                            <div className="font-medium">+7 913 904 04 20</div>

                            <div className="font-medium">Академика Сандахчиева, 5</div>
                            <div className="font-medium">+7 913 014 14 20</div>
                        </div>
