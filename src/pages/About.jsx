...
export default function About() {
    useEffect(() => {
        document.title = "О нас | BurgerBrand";
    }, []);
    ...
    const sections = [
        ...
        },
        {
            ...
            content: (
                <>
                    <div className="space-y-4">
                        <div>
                            <h4 className="font-black uppercase tracking-widest text-brand-accent text-sm">Север</h4>
                            <p>Мы начались с OG BurgerBrand в Севергородке на ул.ул. Зимняя, 20 и продолжились в других районах Новосибирска.</p>
                        </div>
                        <div>
                            <h4 className="font-black uppercase tracking-widest text-brand-accent text-sm">Центр</h4>
                            <p>Сейчас ты можешь найти в центре города большой B&B KOM45 с диджеями по пятницам и субботам по адресу пл. Весенняя, 5, а также маленький B&B Lite на ул.ул. Парковая, 1.</p>
                        </div>
                        <div>
                            <h4 className="font-black uppercase tracking-widest text-brand-accent text-sm">Западный берег</h4>
                            <p>Западный берег представлен точкой B&B NSTU по адресу ул.ул. Летняя, 10 (в общежитии НГТУ номер 6).</p>
                        </div>
                        <div>
                            <h4 className="font-black uppercase tracking-widest text-brand-accent text-sm">Парк</h4>
                            <p>+ Недавно мы открыли пятый джоинт в Парк по адресу ул. ул. Осенняя, 15.</p>
                        </div>
                    </div>
                </>
            ),
            ...
            reverse: false,
            tag: "OPEN 24/7" // Based on reference design logic
        },
        {
            ...
            content: (
                <>
                    ...
                    <p className="font-bold text-lg mb-6">Приходи получать опыт BurgerBrand, есть, пить, слушать и болтать!</p>
