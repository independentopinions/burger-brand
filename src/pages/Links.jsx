...
export default function Links() {
    useEffect(() => {
        document.title = "Ссылки | BurgerBrand";
    }, []);

    const links = [
        { type: 'external', href: 'https://t.me/burgerbrand/1362', img: 'https://cdn.prod.website-files.com/64d8af984c758e0313a895b7/65c467c1e1f2a4ceb2fa53ab_Frame%2070..png', alt: 'Доставка / Предзаказ' },
        { type: 'external', href: 'https://t.me/burgerbrand', img: 'https://cdn.prod.website-files.com/64d8af984c758e0313a895b7/65c468147a7c0e565416c08c_Frame%2071..png', alt: 'Оставить Отзыв' },
        ...
        { type: 'external', href: '#', img: 'https://cdn.prod.website-files.com/64d8af984c758e0313a895b7/65c468c1315e98aa8424c6b7_Frame%2075..png', alt: 'Ищу Работу' },
        { type: 'external', href: '#', img: 'https://cdn.prod.website-files.com/64d8af984c758e0313a895b7/65c468e032be69612115fd31_Frame%2076..png', alt: 'Поддержка' }
    ];
